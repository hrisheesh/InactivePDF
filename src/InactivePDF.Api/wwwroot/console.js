...
const state = { token:'', config:null, draft:null, route:'overview', status:null, metrics:null, resources:null, officeSessions:null, history:[], busy:false, profiles:{}, apiKeys:[], assets:[], imageUrls:new Map(), wm:null, wmSaved:null, wmName:'', wmDirty:false, analyticsSource:'' };
const sections = [
...
function applyLive(snapshot){
 state.swarm=snapshot.swarm;state.officeSessions=snapshot.officeSessions;state.watchFolder=snapshot.watchFolder;
